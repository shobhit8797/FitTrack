...
// AI service (spec §10–11)
export { generatePlan, analyzeMeal, parseLabel, estimateText } from './ai/handlers';

// Users / onboarding / targets (spec §4–5)
export { completeOnboarding, recomputeTargets } from './users/handlers';
